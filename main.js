...
document.getElementById("name").innerHTML= "The " + noun1 +verb+" to the" + noun2 + "." +" at the" + noun2 + "." + "and then the "  + verb2 + "then he went to jail" + noun3+ "."  + "."+ "then he went to get" + verb4+ "."   //   !how are you today?" + font + " what is your favotite font, apparently"; 
